...
import com.shopsphere.product.dto.response.ApiResponse;
...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse<Product>> updateProduct(@PathVariable Long id, @RequestBody Product updates) {
        return productRepository.findById(id)
                .map(p -> {
    ...
    public ResponseEntity<ApiResponse<Category>> updateCategory(@PathVariable Long id, @RequestBody Category updates) {
        return categoryRepository.findById(id)
                .map(c -> {
